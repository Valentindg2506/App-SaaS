...
if ($res && $res->num_rows > 0) {
    ...
    $nombre_completo = $conexion->real_escape_string($p['nombre'] . ' ' . $p['apellido']);
    ...
    $insertSql = "INSERT INTO cliente (nombre_completo, email, telefono, direccion, empresa) VALUES ('$nombre_completo', '$email', '$telefono', '$direccion', '$empresa')";
