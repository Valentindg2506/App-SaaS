            ...
            <?php foreach($clientes_por_fase[$fase] as $c): ?>
                <div class="kanban-card" 
					...
					<div style="margin-top:8px; display:flex; justify-content:flex-end; align-items:center;">
						<a href="?operacion=editar&tabla=cliente&id=<?= $c['id'] ?>&pk=id" title="Editar" style="text-decoration:none; padding:5px; background:var(--bg-body); border-radius:4px;">✏️ Editar</a>
					</div>
                </div>
            <?php endforeach; ?>
        </div>
