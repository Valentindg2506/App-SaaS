<?php
// Configuración de las 8 Fases del Kanban
$fases = [
    'Nuevo', 
    'Contactado', 
    'No respondió', // <--- NUEVA FASE (8va)
    'Interesado', 
    'En Negociación', 
    'Presupuesto', 
    'Compró', 
...
$colores_fase = [
    ...
    'En Negociación' => 'border-top: 3px solid #eab308;', // Yellow
...
$sql = "SELECT id, nombre, apellido, empresa, fase, telefono FROM cliente ORDER BY created_at DESC";
...
<div class="header-title">
    <h2>Tablero Kanban: <span style="color:var(--accent)">Clientes</span></h2>
